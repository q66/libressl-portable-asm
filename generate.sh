...
generate_ppc() {
    ...
    perlasm $1 modes/asm/ghashp8-ppc.pl modes/ghashp8
    perlasm $1 sha/asm/sha1-ppc.pl sha/sha1
    perlasm $1 sha/asm/sha512-ppc.pl sha/sha256
    perlasm $1 sha/asm/sha512-ppc.pl sha/sha512
    perlasm $1 sha/asm/sha512p8-ppc.pl sha/sha256p8
    perlasm $1 sha/asm/sha512p8-ppc.pl sha/sha512p8
    perlasm $1 ppccpuid.pl cpuid
}
